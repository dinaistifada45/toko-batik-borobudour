...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('dashboard'); ?>">
            ...
            <div class="sidebar-brand-text mx-3">Toko Batik Borobudour <sup></sup></div>
        </a>
...
<ul class="navbar-nav ml-auto align-items-center">
    ...
    <li class="nav-item mx-2 d-flex align-items-center">
        <?php
        $keranjang = '<i class="fas fa-shopping-cart"></i> Keranjang: ' . $this->cart->total_items() . ' items';
        echo anchor('dashboard/detail_keranjang', $keranjang, ['class' => 'btn btn-sm btn-warning']);
        ?>
    </li>
